...
class English extends Lang {
    ...
    public static function translations(): array {
        return [
            ...
            'class_schedule_created_successfully' => 'Meeting "{{name}}" created successfully',
            'class_schedule_updated_successfully' => 'Meeting "{{name}}" updated successfully',
            'class_schedule_deleted_successfully' => 'Meeting "{{name}}" deleted successfully',
            'class_schedule_published_successfully' => 'Meeting "{{name}}" published',
            'class_schedule_cancelled_successfully' => 'Meeting "{{name}}" cancelled — its slot is free again',
            'class_schedule_is_in_use' => 'This meeting is referenced elsewhere and cannot be deleted',
            'only_draft_schedules_can_be_edited' => 'Only a draft meeting can be adjusted',
            'only_draft_schedules_can_be_deleted' => 'Only a draft meeting can be deleted — cancel a published one instead',
            'schedule_needs_a_room_and_an_instructor' => 'Give the meeting a room and an instructor before publishing it',
            ...
            // exam scheduling
            'exam_schedule_not_found' => 'Exam sitting not found',
            'exam_schedule_created_successfully' => 'Sitting "{{name}}" created successfully',
            'exam_schedule_updated_successfully' => 'Sitting "{{name}}" updated successfully',
            'exam_schedule_deleted_successfully' => 'Sitting "{{name}}" deleted successfully',
            'exam_schedule_sent_for_confirmation' => 'Sitting "{{name}}" sent to the department for confirmation',
            'exam_schedule_confirmed_successfully' => 'Sitting "{{name}}" confirmed',
            'exam_schedule_published_successfully' => 'Sitting "{{name}}" published',
            'exam_schedule_cancelled_successfully' => 'Sitting "{{name}}" cancelled — its hall is free again',
            'exam_schedule_is_in_use' => 'This sitting is referenced elsewhere and cannot be deleted',
            'only_draft_exams_can_be_edited' => 'Only a draft sitting can be adjusted',
            'only_draft_exams_can_be_deleted' => 'Only a draft sitting can be deleted — cancel a published one instead',
            'exam_needs_a_room' => 'Give the sitting a hall before publishing it',
            'exam_already_scheduled_for_offering' => 'This offering already has a sitting of that exam type',
            ...
            'exam_schedule_generation_completed' => 'Generation finished — {{scheduled}} sittings placed, {{unplaced}} offerings left unplaced',
            ...
            'invigilators_assigned_successfully' => 'Staffing finished — {{assigned}} duties assigned, {{short}} sittings still short',
            ...
            'no_exams_to_staff' => 'This semester has no exam sittings to staff',
            ...
            'invigilator_assignment' => [
                'exam_schedule_id.required' => 'Please choose an exam sitting',
                'exam_schedule_id.exists' => 'The selected exam sitting does not exist',
                'instructor_id.required' => 'Please choose an instructor',
                'instructor_id.exists' => 'The selected instructor does not exist',
                'semester_id.required' => 'Please choose a semester',
                'semester_id.exists' => 'The selected semester does not exist',
            ...
            'class_schedule_generation_completed' => 'Generation finished — {{scheduled}} meetings placed, {{unplaced}} offerings left unplaced',

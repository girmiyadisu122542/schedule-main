...
class Amharic extends Lang {
    ...
    public static function translations(): array {
        return [
            ...
            'user_has_no_email' => 'ይህ ተጠቃሚ የመግቢያ መረጃ የሚላክበት ኢሜይል የለውም',
            'credentials_could_not_be_sent' => 'አዲሱ የይለፍ ቃል በኢሜይል መላክ አልተቻለም፤ ምንም አልተቀየረም።',
            'password_resent' => 'አዲስ የይለፍ ቃል ወደ {{email}} ተልኳል',
            'bulk_action_completed' => '{{succeeded}} ተሳክቷል፣ {{failed}} አልተሳካም',
            'schedule_out_of_scope' => 'ይህ መርሐግብር የሌላ ትምህርት ክፍል ነው',
            'not_entitled_to_decide_this_tier' => 'ይህ ኮርስ የሚጠብቀውን ውሳኔ ለመስጠት ፈቃድ የለዎትም',
            'not_found_or_out_of_scope' => 'አልተገኘም ወይም የእርስዎ አይደለም',
            'only_draft_schedules_can_be_deleted' => 'ረቂቅ ክፍለ ጊዜ ብቻ ሊሰረዝ ይችላል',
            'only_draft_exams_can_be_deleted' => 'ረቂቅ ፈተና ብቻ ሊሰረዝ ይችላል',
            'offering_already_has_its_weekly_sessions' => 'ይህ ኮርስ በሳምንት የሚያስፈልገውን ክፍለ ጊዜ ሁሉ አግኝቷል። ነባሩን ያስተካክሉ ወይም የኮርሱን የሳምንት ሰዓት ይጨምሩ።',
            'class_schedules_created_summary' => '{{created}} ክፍለ ጊዜ ተፈጥሯል፣ {{failed}} አልተቻለም',
            'room_capacity_is_too_small' => 'የተመረጠው ክፍል ለዚህ ቡድን በቂ አይደለም',
            'unauthorized_action' => 'ይህን ተግባር ለማከናወን ፈቃድ የለዎትም።',
            'offering_department_out_of_scope' => 'የራስዎ ትምህርት ክፍል ላይ ብቻ መስራት ይችላሉ። መለያዎ ከዚህ ትምህርት ክፍል ጋር አልተገናኘም።',
            'room_is_not_owned_by_department' => 'ይህ ክፍል ለዚህ ትምህርት ክፍል አልተመደበም',
            'room_belongs_to_another_department' => 'ከተመረጡት ክፍሎች አንዱ ቀድሞ ለሌላ ትምህርት ክፍል ተመድቧል',
